...
public class Myshyk_Cat {
    ...
    public int getVolumeKolomu() {
        return volumeKolomu;
    }

    public void setVolumeKolomu(int volumeKolomu) {
        this.volumeKolomu = volumeKolomu;
    }

    public int getGrowthRost() {
        return growthRost;
    }

    public void setGrowthRost(int growthRost) {
        this.growthRost = growthRost;
    }

    public void actionsDeistvia(){
        System.out.println("The cat can catch mice ");
